-- Total Revenue per Driver (including tips and surge)
...
-- Top 5 Riders by Trip Count in Last 6 Months
...
-- Average Trip Distance by Vehicle Make & Model
...
-- Cancelled Trip Percentage by Trip Status
